...
::: tip Exercise
Follow the tutorial at [SDCard - FileSystem](/info-SDcard) where there is explained how to extract the `rootfs.tar` to our memory card.
