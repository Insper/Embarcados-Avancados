...
- [Github Classroom](https://classroom.github.com/a/I_3lQs3G)
...
Note that all solutions require a network connection, for this follow the script: [Info HPS Ethernet](/info-HPS-ethernet).
