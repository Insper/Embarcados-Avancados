...
Processadores que são sintetizáveis em dispositivos lógicos programáveis (FPGA,..) são chamados de [Soft Processor](https://en.wikipedia.org/wiki/Soft_microprocessor). Diversos são os Soft Processors disponíveis comercialmente/ open source: 
...
- [Processor Architecture](https://www.intel.com/content/www/us/en/programmable/documentation/iga1420498949526.html#iga1409259423560)
...
4. Adicione os seguintes periféricos:
...
- [Avalon Interface Specifications](https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/manual/mnl_avalon_spec.pdf)
...
Note que o NIOS possui dois barramentos do tipo **MM**: `data_master` e `intruction_master`. Como o NIOS II é um processador baseado no MIPS  [harvard](http://infocenter.arm.com/help/index.jsp?topic=/com.arm.doc.faqs/ka3839.html) ele possui dois barramentos, um para dados e outro para o programa (instrução).
...
Ainda no Qsys, clique em: `Generate` :arrow_right: `Show Instatiation Template`, selecione VHDL como linguagem HDL. E você deve obter algo como:
...
1. No **Quartus** :arrow_right: `Tools` :arrow_right: `NIOS II - Eclipse`
1. No **NIOS II - Eclipse** :arrow_right: `File` :arrow_right: `NIOS II Application and BSP from template`
...
De volta no eclipse, devemos gerar os arquivos bsp. Para isso clique em: `niosHello_bsp` :arrow_right: `NIOS II` :arrow_right: `Generate BSP`
...
![printf](figs/Tutorial-FPGA-NIOS:console.png)
